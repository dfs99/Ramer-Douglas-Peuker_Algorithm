...
class PerformancePy:
    ...
    def benchmark(func):
        ...
        def wrapper_timer(*args, **kwargs):
            ...
            args_info = PerformancePy._get_function_args(*args)
            kwargs_info = PerformancePy._get_function_kwargs(**kwargs)
            results = """
            Function benchmark:
            ->  Function name:\t{0}.
    ...
    @staticmethod
    def _get_function_kwargs(**kwargs):
        kwargs_info = ""
        if bool(kwargs):
